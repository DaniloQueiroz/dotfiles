...
files='.config/fish/ .screen/* .vimrc .git_commit_msg .gitconfig .gitignore_global .xchat2/xchat.conf .xchat2/keybindings.conf .ackrc .conkyrc tools/todo.txt/ .ssh/ .config/compiz-1/'
