...
files='.config/fish/ .screen/* .vimrc .gitconfig .gitignore_global .xchat2/xchat.conf .xchat2/keybindings.conf .ackrc .conkyrc .todo/ tools/todo.txt/ .ssh/ .config/compiz-1/'
